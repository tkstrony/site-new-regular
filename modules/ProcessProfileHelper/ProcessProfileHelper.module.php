...
/**
 * ProcessProfileHelper Module for ProcessWire 3.x
 *
...
class ProcessProfileHelper extends Process implements ConfigurableModule {
	...
	public function ___execute() {
		...
		return [
			...
			'actions' => [
				'./manage-logs/' => $this->_('Manage logs'),
	 ...
	 *
	 */
	public function ___executeManageLogs() {

		$this->headline($this->_('Manage Logs'));

		// send variables to our manage-logs.php view file:
		return [
			'labelDelLogs' => $this->_('Delete selected logs'),
			'labelSearchLogs' => $this->_('Search logs...'),
			'$labelDeleteLogs' => $this->_('Delete Logs'),
			'labelViewLog' => $this->_('View this log'),
			'labelStartDate' => $this->_('Start Date'),
			'labelEndDate' => $this->_('End Date'),
			'labelSearch' => $this->_('Search'),
			'alpineURL' => '//unpkg.com/alpinejs',
		];
	}

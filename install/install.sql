# --- WireDatabaseBackup {"time":"2025-03-28 18:28:20","user":"","dbName":"db","description":"","tables":[],"excludeTables":["pages_drafts","pages_roles","permissions","roles","roles_permissions","users","users_roles","user","role","permission"],"excludeCreateTables":[],"excludeExportTables":["field_roles","field_permissions","field_email","field_pass","caches","session_login_throttle","page_path_history"]}
...
DROP TABLE IF EXISTS `field_public_slug`;
CREATE TABLE `field_public_slug` (
  `pages_id` int(10) unsigned NOT NULL,
  `data` text NOT NULL,
  PRIMARY KEY (`pages_id`),
  KEY `data_exact` (`data`(191)),
...
INSERT INTO `field_public_slug` (`pages_id`, `data`) VALUES('41', 'John Doe');
...
INSERT INTO `fieldgroups_fields` (`fieldgroups_id`, `fields_id`, `sort`, `data`) VALUES('3', '133', '0', NULL);
...
CREATE TABLE `fields` (
  ...
  UNIQUE KEY `name` (`name`),
  KEY `type` (`type`)
) ENGINE=MyISAM AUTO_INCREMENT=134 DEFAULT CHARSET=utf8 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `fields` (`id`, `type`, `name`, `flags`, `label`, `data`) VALUES('133', 'FieldtypeText', 'public_slug', '0', 'Public Slug', '{\"textformatters\":[\"TextformatterEntities\"],\"collapsed\":0,\"minlength\":0,\"maxlength\":2048,\"showCount\":0,\"size\":0,\"tags\":\"user\",\"icon\":\"hand-lizard-o\",\"notes\":\"A unique public name for the user, displayed instead of the username for security reasons.\"}');
...
) ENGINE=MyISAM AUTO_INCREMENT=6072 DEFAULT CHARSET=utf8 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `modules` (`id`, `class`, `flags`, `data`, `created`) VALUES('138', 'ProcessProfile', '1', '{\"profileFields\":[\"admin_theme\",\"email\",\"pass\",\"public_slug\"]}', '2025-02-15 20:49:57');
...
INSERT INTO `modules` (`id`, `class`, `flags`, `data`, `created`) VALUES('5618', 'HelperOembed', '3', '{\"instagram_access_token\":\"\",\"facebook_access_token\":\"\",\"profiles_img_page_id\":\"1073\",\"duration\":\"21600\",\"clearCache\":\"\"}', '2025-02-21 13:00:24');
INSERT INTO `modules` (`id`, `class`, `flags`, `data`, `created`) VALUES('5619', 'HelperMaintenance', '1', '', '2025-02-21 13:00:24');
...
) ENGINE=MyISAM AUTO_INCREMENT=1175 DEFAULT CHARSET=utf8 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `pages` (`id`, `parent_id`, `templates_id`, `name`, `status`, `modified`, `modified_users_id`, `created`, `created_users_id`, `published`, `sort`) VALUES('2', '1', '2', 'proc', '1035', '2025-03-28 17:24:34', '40', '2025-02-15 20:49:57', '41', '2025-02-15 20:49:57', '11');
...
INSERT INTO `pages` (`id`, `parent_id`, `templates_id`, `name`, `status`, `modified`, `modified_users_id`, `created`, `created_users_id`, `published`, `sort`) VALUES('41', '29', '3', 'raf', '1', '2025-03-28 17:50:42', '41', '2025-02-15 20:49:57', '41', '2025-02-15 20:49:57', '0');
...
INSERT INTO `templates` (`id`, `name`, `fieldgroups_id`, `flags`, `cache_time`, `data`) VALUES('1', 'home', '1', '0', '0', '{\"useRoles\":1,\"noParents\":1,\"slashUrls\":1,\"pageLabelField\":\"fa-home title\",\"compile\":0,\"modified\":1742498943,\"ns\":\"ProcessWire\",\"_lazy\":1,\"roles\":[37]}');
INSERT INTO `templates` (`id`, `name`, `fieldgroups_id`, `flags`, `cache_time`, `data`) VALUES('2', 'admin', '2', '8', '0', '{\"useRoles\":1,\"parentTemplates\":[2],\"allowPageNum\":1,\"redirectLogin\":23,\"slashUrls\":1,\"noGlobal\":1,\"compile\":3,\"modified\":1742498943,\"ns\":\"ProcessWire\",\"_lazy\":1}');
INSERT INTO `templates` (`id`, `name`, `fieldgroups_id`, `flags`, `cache_time`, `data`) VALUES('3', 'user', '3', '8', '0', '{\"useRoles\":1,\"noChildren\":1,\"parentTemplates\":[2],\"slashUrls\":1,\"pageClass\":\"User\",\"noGlobal\":1,\"noMove\":1,\"noTrash\":1,\"noSettings\":1,\"noChangeTemplate\":1,\"compile\":0,\"nameContentTab\":1,\"modified\":1743179933,\"_lazy\":1}');
INSERT INTO `templates` (`id`, `name`, `fieldgroups_id`, `flags`, `cache_time`, `data`) VALUES('4', 'role', '4', '8', '0', '{\"noChildren\":1,\"parentTemplates\":[2],\"slashUrls\":1,\"pageClass\":\"Role\",\"noGlobal\":1,\"noMove\":1,\"noTrash\":1,\"noSettings\":1,\"noChangeTemplate\":1,\"nameContentTab\":1}');
INSERT INTO `templates` (`id`, `name`, `fieldgroups_id`, `flags`, `cache_time`, `data`) VALUES('5', 'permission', '5', '8', '0', '{\"noChildren\":1,\"parentTemplates\":[2],\"slashUrls\":1,\"guestSearchable\":1,\"pageClass\":\"Permission\",\"noGlobal\":1,\"noMove\":1,\"noTrash\":1,\"noSettings\":1,\"noChangeTemplate\":1,\"nameContentTab\":1}');
INSERT INTO `templates` (`id`, `name`, `fieldgroups_id`, `flags`, `cache_time`, `data`) VALUES('29', 'basic-page', '83', '0', '0', '{\"slashUrls\":1,\"pageLabelField\":\"fa-book title\",\"compile\":0,\"modified\":1742498943,\"ns\":\"ProcessWire\",\"_lazy\":1}');
...
INSERT INTO `templates` (`id`, `name`, `fieldgroups_id`, `flags`, `cache_time`, `data`) VALUES('46', 'http404', '100', '0', '0', '{\"noChildren\":1,\"noParents\":-1,\"slashUrls\":1,\"pageLabelField\":\"fa-shower title\",\"compile\":0,\"modified\":1742498943,\"ns\":\"ProcessWire\",\"_lazy\":1}');
INSERT INTO `templates` (`id`, `name`, `fieldgroups_id`, `flags`, `cache_time`, `data`) VALUES('47', 'contact', '101', '0', '0', '{\"noParents\":-1,\"slashUrls\":1,\"pageLabelField\":\"fa-black-tie title\",\"compile\":0,\"modified\":1742498943,\"ns\":\"ProcessWire\",\"_lazy\":1}');
INSERT INTO `templates` (`id`, `name`, `fieldgroups_id`, `flags`, `cache_time`, `data`) VALUES('48', 'personal-data', '102', '0', '0', '{\"noParents\":-1,\"slashUrls\":1,\"pageLabelField\":\"fa-unlock-alt title\",\"compile\":0,\"modified\":1742498943,\"ns\":\"ProcessWire\",\"_lazy\":1}');
...
INSERT INTO `templates` (`id`, `name`, `fieldgroups_id`, `flags`, `cache_time`, `data`) VALUES('59', 'categories', '113', '0', '0', '{\"noParents\":-1,\"childTemplates\":[61],\"allowPageNum\":1,\"slashUrls\":1,\"pageLabelField\":\"fa-th-large title\",\"compile\":0,\"tags\":\"blog\",\"modified\":1742498943,\"ns\":\"ProcessWire\",\"_lazy\":1}');
INSERT INTO `templates` (`id`, `name`, `fieldgroups_id`, `flags`, `cache_time`, `data`) VALUES('60', 'blog', '114', '0', '0', '{\"noParents\":-1,\"childTemplates\":[62],\"allowPageNum\":1,\"slashUrls\":1,\"pageLabelField\":\"fa-coffee title\",\"compile\":0,\"tags\":\"blog\",\"modified\":1742498943,\"ns\":\"ProcessWire\",\"_lazy\":1}');
INSERT INTO `templates` (`id`, `name`, `fieldgroups_id`, `flags`, `cache_time`, `data`) VALUES('61', 'category', '115', '0', '0', '{\"parentTemplates\":[59],\"slashUrls\":1,\"pageLabelField\":\"fa-square-o title\",\"compile\":0,\"label\":\"Category\",\"tags\":\"blog\",\"modified\":1742498943,\"ns\":\"ProcessWire\",\"_lazy\":1}');
INSERT INTO `templates` (`id`, `name`, `fieldgroups_id`, `flags`, `cache_time`, `data`) VALUES('62', 'blog-post', '116', '0', '0', '{\"childTemplates\":[62],\"parentTemplates\":[60],\"allowPageNum\":1,\"slashUrls\":1,\"pageLabelField\":\"fa-file-text-o title\",\"compile\":0,\"label\":\"Post\",\"tags\":\"blog\",\"modified\":1742498943,\"ns\":\"ProcessWire\",\"_lazy\":1}');
INSERT INTO `templates` (`id`, `name`, `fieldgroups_id`, `flags`, `cache_time`, `data`) VALUES('63', 'sitemap', '117', '0', '0', '{\"noChildren\":1,\"noParents\":-1,\"slashUrls\":1,\"pageLabelField\":\"fa-map-signs title\",\"compile\":0,\"modified\":1742498943,\"ns\":\"ProcessWire\",\"_lazy\":1}');
INSERT INTO `templates` (`id`, `name`, `fieldgroups_id`, `flags`, `cache_time`, `data`) VALUES('65', 'user-zone', '119', '0', '0', '{\"noChildren\":1,\"noParents\":-1,\"slashUrls\":1,\"pageLabelField\":\"fa-user-o title\",\"compile\":0,\"modified\":1742498943,\"ns\":\"ProcessWire\",\"_lazy\":1}');
...
# --- /WireDatabaseBackup {"numTables":49,"numCreateTables":55,"numInserts":1132,"numSeconds":0}
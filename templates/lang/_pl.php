...
return [
    ...
    // proces formularza
    'succesMessage' => __('Formularz został pomyślnie wysłany.'),
    'errorMessage' => __('Formularz nie został poprawnie przesłany.'),
    'thanksMesage' => __('Dziękujemy za wiadomość, postaramy się odpowiedzieć jak najszybciej. Poniżej treść Twojej wiadomości.'),
    'submitAgain' => __('Prześlij ponownie'),
    'failedResponse' => __('Form submission failed !!!'),
